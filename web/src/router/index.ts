...
const router = createRouter({
  ...
  routes: [
    ...
    // 平台布局
    {
      ...
      meta: { roles: [ROLES.PLATFORM, ROLES.PLATFORM_STAFF, ROLES.ROOT], title: '平台' }, // 平台管理员和Root可见
      children: [
        {
          path: 'dashboard',
        ...
        },
        {
          ...
          meta: {
            title: '账号管理',
            icon: 'User',
            roles: [ROLES.PLATFORM, ROLES.ROOT],
          },
        },
      ],
    },
      ...
      children: [
        ...
        // --- School Menu ---
        {
          ...
          meta: {
            title: '供应链管理',
            icon: 'Box',
            roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT],
          },
          children: [
            {
              path: 'supplier',
              component: () => import('@/views/workspace/scm/SupplierManagement.vue'),
              meta: { title: '供应商管理', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'staff',
              component: () => import('@/views/workspace/scm/SupplierStaff.vue'),
              meta: { title: '供应商员工', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'order',
              component: () => import('@/views/workspace/scm/SupplierOrder.vue'),
              meta: { title: '供应商订单', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              meta: { title: '食堂总览', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'merchant',
              component: () => import('@/views/workspace/canteen/MerchantList.vue'),
              meta: { title: '商户列表', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              meta: { title: '订单汇总', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'list',
              component: () => import('@/views/workspace/order/OrderList.vue'),
              meta: { title: '商户订单', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'aftersales',
              component: () => import('@/views/workspace/order/OrderAftersales.vue'),
              meta: { title: '订单售后', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              meta: { title: '商品审核', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'library',
              component: () => import('@/views/workspace/product/ProductLibrary.vue'),
              meta: { title: '商品库', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'listing',
              component: () => import('@/views/workspace/product/ProductListing.vue'),
              meta: { title: '上架管理', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'pricing',
              component: () => import('@/views/workspace/product/ProductPricing.vue'),
              meta: { title: '商品价格', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              meta: { title: '对账单', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'canteen',
              component: () => import('@/views/workspace/settlement/CanteenSettlement.vue'),
              meta: { title: '食堂结算', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'supplier',
              component: () => import('@/views/workspace/settlement/SupplierSettlement.vue'),
              meta: { title: '供应商结算', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
            {
              path: 'merchant',
              component: () => import('@/views/workspace/settlement/MerchantSettlement.vue'),
              meta: { title: '商户结算', roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT] },
            },
          ],
        },
        {
          ...
          meta: {
            title: '账号管理',
            icon: 'User',
            roles: [ROLES.SCHOOL, ROLES.ROOT],
          },
        },
        {
          path: 'school-supplier',
          component: () => import('@/views/workspace/school/SupplierManagement.vue'),
          meta: {
            title: '供应商管理(新)',
            icon: 'OfficeBuilding',
            roles: [ROLES.SCHOOL, ROLES.SCHOOL_STAFF, ROLES.ROOT],
        ...
        // --- Supplier Menu ---
        {
          ...
          meta: {
            title: '商品管理',
            icon: 'Goods',
            roles: [ROLES.SUPPLIER, ROLES.SUPPLIER_STAFF, ROLES.ROOT],
          },
          children: [
            {
              path: 'upload',
          ...
          children: [
            {
              ...
              meta: { title: '订单', roles: [ROLES.SUPPLIER, ROLES.SUPPLIER_STAFF, ROLES.ROOT] },
            },
            {
              path: 'aftersales',
        ...
        },
        {
          ...
          meta: {
            title: '账号管理',
            icon: 'User',
            roles: [ROLES.SUPPLIER, ROLES.ROOT],
          },
        },
        {
